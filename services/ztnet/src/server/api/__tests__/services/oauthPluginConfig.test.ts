...
// This suite inspects the options handed to Better Auth. Avoid constructing a
// live auth context: generic OAuth discovery is asynchronous and would make a
// unit test perform an external request after Jest has finished.
